...
# Video edit / extend (seedance 2.x). Video inputs must be web URLs —
# the API rejects base64 video; reuse a previous task's video_url or upload to TOS/OSS
seedance-cli generate -p "repaint walls blue" --video "https://example.com/orig.mp4" \
  --duration 5 --out edited.mp4
...
seedance-cli generate -p "repaint walls blue" -m 2.5 --video "https://example.com/orig.mp4" \
